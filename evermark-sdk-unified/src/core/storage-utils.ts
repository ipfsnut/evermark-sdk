...
export function createDefaultStorageConfig(
  ...
  existingClient?: any // ✅ FIXED: Added optional client parameter
): StorageConfig {
 ...
 */
export function migrateStorageConfig(config: StorageConfig): StorageConfig {
 ...
 */
export function createStorageConfigWithClient(
  supabaseUrl: string,
  supabaseKey: string,
  bucketName: string,
  client: any
