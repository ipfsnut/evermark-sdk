 ...
 */
export const EvermarkImage = ({ evermark, variant = 'standard', showPlaceholder = true, className = '', onImageLoad, onImageError }) => {
    ...
    // Resolution config
    const resolutionConfig = { maxSources: 3 };
    if (preferThumbnail) {
